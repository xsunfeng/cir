function CirClaim() {
	...
	$('#claim-pane').on('click', '.claim-vote-btn', function() {
		...
		_this.flag({
			...
			$('#claim-pane .flag-tags[data-id="' + claim_id + '"] a').popup();
		});
		...
		_this.flag({
			...
			$('#claim-pane .theme-tags[data-id="' + claim_id + '"] a').popup();
		});
