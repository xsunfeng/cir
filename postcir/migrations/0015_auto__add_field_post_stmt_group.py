...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.stmt_group'
        db.add_column(u'postcir_post', 'stmt_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['postcir.StatementGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.stmt_group'
        db.delete_column(u'postcir_post', 'stmt_group_id')
    ...
    models = {
        ...
        u'postcir.post': {
            ...
            'stmt_group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['postcir.StatementGroup']", 'null': 'True', 'blank': 'True'}),
