...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserEvent.event'
        db.alter_column(u'postcir_userevent', 'event', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'UserEvent.event'
        db.alter_column(u'postcir_userevent', 'event', self.gf('django.db.models.fields.CharField')(max_length=10))
