...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StatementGroup.extra_description'
        db.add_column(u'postcir_statementgroup', 'extra_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StatementGroup.extra_description'
        db.delete_column(u'postcir_statementgroup', 'extra_description')
