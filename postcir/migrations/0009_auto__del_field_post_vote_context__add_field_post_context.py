...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.vote_context'
        db.delete_column(u'postcir_post', 'vote_context')

        # Adding field 'Post.context'
        db.add_column(u'postcir_post', 'context',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Post.vote_context'
        db.add_column(u'postcir_post', 'vote_context',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Post.context'
        db.delete_column(u'postcir_post', 'context')
