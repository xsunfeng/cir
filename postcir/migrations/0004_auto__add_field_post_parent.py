...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'postcir_post', 'parent',
                      self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['postcir.Post']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.parent'
        db.delete_column(u'postcir_post', 'parent_id')
