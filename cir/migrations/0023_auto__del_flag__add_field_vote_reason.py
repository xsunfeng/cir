...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vote.reason'
        db.add_column(u'cir_vote', 'reason',
                      self.gf('django.db.models.fields.CharField')(max_length=2010, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Vote.reason'
        db.delete_column(u'cir_vote', 'reason')
    ...
    models = {
        ...
        u'cir.claimreference': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_adopted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
