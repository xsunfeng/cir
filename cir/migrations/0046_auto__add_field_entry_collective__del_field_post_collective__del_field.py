...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.collective'
        db.add_column(u'cir_entry', 'collective',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Post.collective'
        db.delete_column(u'cir_post', 'collective')

        # Deleting field 'Post.target'
        db.delete_column(u'cir_post', 'target_id')

        # Adding field 'Post.target_entry'
        db.add_column(u'cir_post', 'target_entry',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='get_comments', null=True, to=orm['cir.Entry']),
                      keep_default=False)

        # Adding field 'Post.target_event'
        db.add_column(u'cir_post', 'target_event',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='get_comments', null=True, to=orm['cir.Event']),
                      keep_default=False)

        # Adding field 'Event.collective'
        db.add_column(u'cir_event', 'collective',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.collective'
        db.delete_column(u'cir_entry', 'collective')

        # Adding field 'Post.collective'
        db.add_column(u'cir_post', 'collective',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Post.target'
        db.add_column(u'cir_post', 'target',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='get_comments', null=True, to=orm['cir.Entry'], blank=True),
                      keep_default=False)

        # Deleting field 'Post.target_entry'
        db.delete_column(u'cir_post', 'target_entry_id')

        # Deleting field 'Post.target_event'
        db.delete_column(u'cir_post', 'target_event_id')

        # Deleting field 'Event.collective'
        db.delete_column(u'cir_event', 'collective')
    ...
    models = {
        ...
        u'cir.post': {
            ...
            'target_entry': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'get_comments'", 'null': 'True', 'to': u"orm['cir.Entry']"}),
            'target_event': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'get_comments'", 'null': 'True', 'to': u"orm['cir.Event']"}),
            'title': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        u'cir.role': {
