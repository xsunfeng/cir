...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.entry_ptr'
        db.delete_column(u'cir_post', u'entry_ptr_id')

        # Deleting field 'Post.title'
        db.delete_column(u'cir_post', 'title')


    def backwards(self, orm):
        # Adding field 'Post.entry_ptr'
        db.add_column(u'cir_post', u'entry_ptr',
        ...
        db.add_column(u'cir_post', 'title',
