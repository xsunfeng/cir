...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClaimReference.is_adopted'
        db.add_column(u'cir_claimreference', 'is_adopted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClaimReference.is_adopted'
        db.delete_column(u'cir_claimreference', 'is_adopted')
