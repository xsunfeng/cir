...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cir_claimreference', (
            ...
            ('from_claim', self.gf('django.db.models.fields.related.ForeignKey')(related_name='older_claims', to=orm['cir.Claim'])),
            ('to_claim', self.gf('django.db.models.fields.related.ForeignKey')(related_name='newer_claims', to=orm['cir.Claim'])),
        ))
        db.send_create_signal(u'cir', ['ClaimReference'])

        # Adding model 'Flag'
        db.create_table(u'cir_flag', (
            (u'event_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cir.Event'], unique=True, primary_key=True)),
            ('flag_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('reason', self.gf('django.db.models.fields.CharField')(max_length=2010, null=True, blank=True)),
        ))
        db.send_create_signal(u'cir', ['Flag'])

        # Adding model 'Event'
        db.create_table(u'cir_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(related_name='voters', to=orm['cir.Entry'])),
        ...
        # Deleting field 'Vote.id'
        db.delete_column(u'cir_vote', u'id')

        # Deleting field 'Vote.user'
        db.delete_column(u'cir_vote', 'user_id')

        # Deleting field 'Vote.entry'
        db.delete_column(u'cir_vote', 'entry_id')

        # Deleting field 'Vote.created_at'
        db.delete_column(u'cir_vote', 'created_at')

        # Adding field 'Vote.event_ptr'
        db.add_column(u'cir_vote', u'event_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['cir.Event'], unique=True, primary_key=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Vote.id'
        db.add_column(u'cir_vote', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)

        # Adding field 'Vote.user'
        db.add_column(u'cir_vote', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Vote.entry'
        db.add_column(u'cir_vote', 'entry',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='voters', to=orm['cir.Entry']),
                      keep_default=False)

        # Adding field 'Vote.created_at'
        db.add_column(u'cir_vote', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 4, 4, 0, 0)),
                      keep_default=False)

        # Deleting field 'Vote.event_ptr'
        db.delete_column(u'cir_vote', u'event_ptr_id')
    ...
    models = {
        ...
        u'cir.claim': {
            ...
            'new_versions': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['cir.Claim']", 'symmetrical': 'False', 'through': u"orm['cir.ClaimReference']", 'blank': 'True'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'source_highlight': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'claims_of_highlight'", 'null': 'True', 'to': u"orm['cir.Highlight']"}),
        ...
        u'cir.claimreference': {
            ...
            'from_claim': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'older_claims'", 'to': u"orm['cir.Claim']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'refer_type': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'to_claim': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'newer_claims'", 'to': u"orm['cir.Claim']"})
        },
        u'cir.claimtheme': {
