...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Claim.is_adopted'
        db.delete_column(u'cir_claim', 'is_adopted')

        # Deleting field 'Claim.entry_ptr'
        db.delete_column(u'cir_claim', u'entry_ptr_id')

        # Adding field 'Claim.id'
        db.add_column(u'cir_claim', u'id',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Claim.is_adopted'
        db.add_column(u'cir_claim', 'is_adopted',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Claim.entry_ptr'
        db.add_column(u'cir_claim', u'entry_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['cir.Entry'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'Claim.id'
        db.delete_column(u'cir_claim', u'id')
