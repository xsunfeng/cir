...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntryCategory.name'
        db.alter_column(u'cir_entrycategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'EntryCategory.category_type'
        db.alter_column(u'cir_entrycategory', 'category_type', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'EntryCategory.name'
        db.alter_column(u'cir_entrycategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'EntryCategory.category_type'
        db.alter_column(u'cir_entrycategory', 'category_type', self.gf('django.db.models.fields.TextField')(max_length=100))
