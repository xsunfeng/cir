...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cir_post', (
            ...
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='get_comments', to=orm['cir.Entry'])),
            ('highlight', self.gf('django.db.models.fields.related.ForeignKey')(related_name='posts_of_highlight', to=orm['cir.Highlight'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='children', null=True, to=orm['cir.Post'])),
    ...
    models = {
        ...
        u'cir.post': {
            ...
            'target': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'get_comments'", 'to': u"orm['cir.Entry']"}),
            'title': ('django.db.models.fields.TextField', [], {'null': 'True'})
        },
        u'cir.role': {
