...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Claim.forum'
        db.add_column(u'cir_claim', 'forum',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cir.Forum']),
                      keep_default=False)

        # Adding field 'Claim.is_deleted'
        db.add_column(u'cir_claim', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Claim.forum'
        db.delete_column(u'cir_claim', 'forum_id')

        # Deleting field 'Claim.is_deleted'
        db.delete_column(u'cir_claim', 'is_deleted')
