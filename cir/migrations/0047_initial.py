...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cir_claim', (
            ...
            ('source_highlight', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='claims_of_highlight', null=True, to=orm['cir.Highlight'])),
        ))
        ...
        db.create_table(u'cir_post', (
            (u'entry_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cir.Entry'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('target_entry', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='get_comments', null=True, to=orm['cir.Entry'])),
            ('target_event', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='get_comments', null=True, to=orm['cir.Event'])),
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['cir.Post'])),
