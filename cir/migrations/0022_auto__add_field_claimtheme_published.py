...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClaimTheme.published'
        db.add_column(u'cir_claimtheme', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClaimTheme.published'
        db.delete_column(u'cir_claimtheme', 'published')
