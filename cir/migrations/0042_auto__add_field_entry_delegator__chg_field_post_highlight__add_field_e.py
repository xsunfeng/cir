...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cir_entry', 'delegator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='delegated_entries', null=True, to=orm['auth.User']),
                      keep_default=False)
        ...
        db.add_column(u'cir_event', 'delegator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='delegated_events', null=True, to=orm['auth.User']),
                      keep_default=False)
