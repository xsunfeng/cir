...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.forum'
        db.add_column(u'cir_entry', 'forum',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cir.Forum']),
                      keep_default=False)

        # Adding field 'Entry.is_deleted'
        db.add_column(u'cir_entry', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.forum'
        db.delete_column(u'cir_entry', 'forum_id')

        # Deleting field 'Entry.is_deleted'
        db.delete_column(u'cir_entry', 'is_deleted')
