...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Entry.delegator'
        db.delete_column(u'cir_entry', 'delegator_id')


        # Changing field 'Post.highlight'
        db.alter_column(u'cir_post', 'highlight_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cir.Highlight']))
        # Deleting field 'Event.delegator'
        db.delete_column(u'cir_event', 'delegator_id')


    def backwards(self, orm):
        # Adding field 'Entry.delegator'
        db.add_column(u'cir_entry', 'delegator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='delegated_entries', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)


        # Changing field 'Post.highlight'
        db.alter_column(u'cir_post', 'highlight_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cir.Highlight']))
        # Adding field 'Event.delegator'
        db.add_column(u'cir_event', 'delegator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='delegated_events', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)
